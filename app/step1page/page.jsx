...
export default function StepOnePage() {
    return (
        <div className='flex flex-col justify-around items-center h-[calc(100vh-42px)]'>
            {/* Title and notification */}
            <div className="text-center">
                <h1 className="font-jomhuria text-blue-600 h1 m-0">Checker</h1>
                <h3 className="m-0 h3 font-inter">Your Check-in setup is <span className="text-blue-600 h3 font-inter">2</span> steps away!</h3>
            </div>
            {/* Dashboard contains an input element to enter Excel link and Link button */}
            <div className="border border-solid border-gray-400 rounded-2xl shadow-md shadow-gray-300 flex flex-col items-center py-14 px-5 w-full lg:w-3/4">
