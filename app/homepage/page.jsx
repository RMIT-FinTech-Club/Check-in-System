    ...
    return (
        ...
        <div className="flex flex-col h-[calc(100vh-42px)] items-center justify-around">
            <div className="flex flex-col items-center">
                <h1 className="w-full lg:w-2/3 text-blue-600 h1 text-center m-0">{metadata.description}</h1>
                <h3 className="text-center h3 m-0">{metadata.label}</h3>
            </div>
            {/* Input link and Link button*/}
            <div className="flex justify-center relative w-full lg:w-3/4 my-1">
            ...
            <div className="flex justify-center">
                <img src="./../homepage.png" alt="Home page" className="w-full -z-10" />
            </div>
        </div>
    )
}